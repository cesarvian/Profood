            ...
            <div class="row">
                <div class="col-lg-3 ds">
                    ...
                    <div class="form-group">
                        <label for="field-12" class="control-label">Producto</label>

                        <select class="form-control" name="idproducto" id="idproducto" onchange="dividirproveedor(this.value)">
                    ...
                    <div class="form-group">
                        <label for="field-12" class="control-label">Fecha de Receta</label>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-border panel-warning widget-s-1">
                                <div class="panel-heading">
                                    <h4 class="mb"><i class="fa fa-archive"></i> <strong>Detalle De La Receta</strong> </h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="field-5" class="control-label">Búsqueda de Materia Prima: <span class="symbol required"></span></label>
                                                <input type="hidden" id="codproducto" name="codproducto">
