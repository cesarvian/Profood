...
try{
        Statement st=null;
        st=conn.createStatement();
        st.executeUpdate("INSERT INTO categoria(nombre_categoria,descripcion_categoria) VALUES ('"+razon+"','"+ruc+"')");
...
out.print("<div class='alert alert-success' role='alert'>valor vacio</div>");
 ...
 try{
        Statement st=null;
        st=conn.createStatement();
        st.executeUpdate("update  categoria set nombre_categoria='"+razon+"', descripcion_categoria='"+ruc+"' where id_categoria='"+pk+"'");
...
String pk =request.getParameter("idproveedor_e");
 ...
 try{
        Statement st=null;
        st=conn.createStatement();
        st.executeUpdate("DELETE FROM categoria WHERE id_categoria='" + pk + "'");
